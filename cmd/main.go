	...
	p := getlongopts.NewParser([]getlongopts.LongOption{
		{
			...
			SetFn:       func(value string) { configFile = value },
		...
		},
		{
			...
			SetFn:       func(value string) { baseUri = value },
		...
		},
		{
			...
			Short:       "p",
			ArgType:     getlongopts.ArgTypeOther,
			SetFn:       func(value string) { port = value },
		...
		},
		{
			...
			SetFn:       func(value string) { uploadDir = value },
		...
		},
		{
			...
			Short:       "d",
			ArgType:     getlongopts.ArgTypeDir,
			SetFn:       func(value string) { downloadDir = value },
		...
		},
		{
			...
			Short:       "l",
			ArgType:     getlongopts.ArgTypeOther,
			SetFn:       func(value string) { logLevel = value },
		...
		},
		{
			...
			SetFn:       func(value string) { fmt.Println(Version); os.Exit(0) },
